...
(1..10).to_a.each do |i|
  user = User.create(email: "test#{i}@tested.com", password: '123456789', password_confirmation: '123456789', account: Account.new( first_name: "John#{i}", last_name: 'doe', gender: 'male'))
